...
import com.github.emmpann.aplikasistoryapp.core.data.local.database.RemoteKeys
...
class StoryRemoteMediator(
    ...
    private suspend fun getRemoteKeysForFirstItem(state: PagingState<Int, StoryResponse>): RemoteKeys? {
